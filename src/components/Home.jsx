...
const HomePage = () => {
  ...
  return (
    <div className="homepage">
      ...
      {/* About Section */}
      <section id="about" className="about section-padding  relative overflow-hidden">
  {/* Background Elements */}
    ...
    <div className="grid lg:grid-cols-2 gap-12 lg:gap-19 items-center">
      ...
      <motion.div {...time_div} variants={titleVariants} className="space-y-8">
        ...
        {/* <motion.div 
          ...
          viewport={{ amount: 0.2 }}
        >
          <button className="group inline-flex items-center gap-2 bg-gradient-to-r from-[#ff6b9d] to-[#f7971e] text-white px-8 py-4 rounded-full font-semibold shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
            Learn More About Us
            <svg 
